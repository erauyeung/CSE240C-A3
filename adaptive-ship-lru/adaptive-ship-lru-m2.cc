...
#define NUM_LEADERS_TOTAL 64 // originally 32 each
#define NUM_LEADERS_SHIP 48 // give 80% to ship
#define NUM_LEADERS_LRU (NUM_LEADERS_TOTAL - NUM_LEADERS_SHIP)
...
bool IsSetShip(uint32_t set) {
    return set < NUM_LEADERS_SHIP;
}
bool IsSetLRU(uint32_t set) {
    return set >= NUM_LEADERS_SHIP && set < NUM_LEADERS_TOTAL;
}
